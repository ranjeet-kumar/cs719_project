...
To tackle this difficulty of huge size of the stochastic program, we sample 100 different sets of 50 random paths along the scenario tree  we solve for 100 different sets of 50 sample paths from the scenario tree and obtain the expected value and confidence interval over it. 
