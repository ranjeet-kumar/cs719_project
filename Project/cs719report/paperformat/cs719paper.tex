...
\subsubsection{Bounds on Sample Average Approximation}
...
By implementing the above procedure, the expected revenue from the market participation policy is \$697.64 with a 95\% confidence interval of [693.95, 701.35]
Time taken to solve the 24-hour horizon problem by Gurobi is less than 2 seconds. 
\section{Conclusions}
